...
describe("getUserSubscriptionsWithDetails", () => {
  beforeEach(() => jest.clearAllMocks());

  it("joins subscription with both user and medicine details for the given user", async () => {
    prisma.subscription.findMany.mockResolvedValue([]);

    await getUserSubscriptionsWithDetails("user_1");
